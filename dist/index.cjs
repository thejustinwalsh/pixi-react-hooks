...
function useAssets(urls) {
  const [state, setState, thenable] = _chunk3M5JBGFOcjs.useAssetState.call(void 0, urls, _chunk3M5JBGFOcjs.isLoaded, _chunk3M5JBGFOcjs.load, _chunk3M5JBGFOcjs.resolve);
...
function useAssetBundle(bundles) {
  const [state, setState, thenable] = _chunk3M5JBGFOcjs.useAssetState.call(void 0, 
    bundles,
