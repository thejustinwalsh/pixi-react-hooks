...
declare function useAssetBundle(bundles: string | string[]): Record<string, ResolvedAsset<any>> | Record<string, Record<string, ResolvedAsset<any>> | Record<string, Record<string, ResolvedAsset<any>>>>;
